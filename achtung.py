...
from keras.layers import Input, Dense, Activation, Flatten, Convolution2D, Conv2D, MaxPool2D
...
hidden = Conv2D(64, kernel_size=(3, 3), activation='relu', padding='same')(main_input)
...
dqn = DQNAgent(model=model, nb_actions=nb_actions, memory=memory, nb_steps_warmup=20, target_model_update=1e-2,
               policy=policy)
